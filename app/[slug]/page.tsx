...
function makeBrandAuthorizedDealerHubSchema(slug: "hamilton-watches-authorized-dealer" | "luminox-watches-authorized-dealer" | "seiko-watches-authorized-dealer") {
  const configurations = {
...
export default async function ConvertedPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      {(slug === "hamilton-watches-authorized-dealer" || slug === "luminox-watches-authorized-dealer" || slug === "seiko-watches-authorized-dealer") && <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(makeBrandAuthorizedDealerHubSchema(slug)) }} />}
